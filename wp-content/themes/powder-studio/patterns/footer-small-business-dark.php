 ...
 * Slug: powder-studio/footer-small-business-dark
 * Categories: footer
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-max-48-font-size"><?php echo esc_html__( 'Designed with love. Powered by WordPress.', 'powder-studio' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<h3 class="wp-block-heading has-text-color has-tiny-font-size" style="color:#a3a3a3;text-transform:uppercase"><?php echo esc_html__( 'Main Office', 'powder-studio' ); ?></h3>
			<!-- /wp:heading -->
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						...
						<!-- /wp:list-item -->
						<!-- wp:list-item -->
						<li><?php echo esc_html__( 'Creative Director', 'powder-studio' ); ?></li>
						<!-- /wp:list-item -->
						<!-- wp:list-item -->
