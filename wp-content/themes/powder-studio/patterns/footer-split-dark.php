 ...
 * Slug: powder-studio/footer-split-dark
 * Categories: footer
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<h2 class="wp-block-heading has-tiny-font-size" style="line-height:1.5;text-transform:uppercase"><?php echo esc_html__( 'Heading', 'powder-studio' ); ?></h2>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"2"}},"className":"is-style-no-style"} -->
					<ul class="is-style-no-style" style="line-height:2">
						<!-- wp:list-item -->
						<li><a href="#"><?php echo esc_html__( 'Link #1', 'powder-studio' ); ?></a></li>
						<!-- /wp:list-item -->
						<!-- wp:list-item -->
						<li><a href="#"><?php echo esc_html__( 'Link #2', 'powder-studio' ); ?></a></li>
						<!-- /wp:list-item -->
						<!-- wp:list-item -->
						<li><a href="#"><?php echo esc_html__( 'Link #3', 'powder-studio' ); ?></a></li>
						<!-- /wp:list-item -->
						<!-- wp:list-item -->
						<li><a href="#"><?php echo esc_html__( 'Link #4', 'powder-studio' ); ?></a></li>
						<!-- /wp:list-item -->
					</ul>
					<!-- /wp:list -->
				</div>
