 ...
 * Slug: powder-studio/footer-featured-dark
 * Categories: footer
...
<p class="has-tiny-font-size" style="font-style:normal;font-weight:400;text-transform:uppercase"><?php echo esc_html__( 'Meet Powder', 'powder-studio' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:heading {"fontSize":"max-60"} -->
				<h2 class="wp-block-heading has-max-60-font-size"><?php echo esc_html__( 'Are you ready to start designing with WordPress?', 'powder-studio' ); ?></h2>
				<!-- /wp:heading -->
				...
				<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--small)">
					...
					<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Learn More', 'powder-studio' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
